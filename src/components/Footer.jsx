        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-2xl">RechargePro</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              India's most trusted mobile recharge platform. Fast, secure, and reliable service for all major operators.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/plans" className="text-gray-400 hover:text-white transition-colors">Recharge Plans</Link></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <a href="mailto:srivathsa.m2024aids@sece.ac.in" className="text-gray-400 hover:text-white transition-colors text-sm break-all">
                  srivathsa.m2024aids@sece.ac.in
                </a>
              </div>
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-purple-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
