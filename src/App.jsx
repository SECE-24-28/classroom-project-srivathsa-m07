  ...
  return (
    <div className="space-y-5 animate-fade-in">
      <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 rounded-xl p-6 text-white shadow-xl animate-gradient">
        ...
        <p className="text-blue-100">Your recharge overview</p>
      </div>
      ...
      <div className="bg-white rounded-xl p-6 shadow-md">
        ...
        {recharges.length === 0 ? (
          <div className="text-center py-8">
            ...
            <Link to="/plans" className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-2 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition-all inline-block">
              Recharge Now
            </Link>
          </div>
        ) : (
          <div className="space-y-3">
            {recharges.slice(0, 5).map(recharge => (
              <div key={recharge.id} className="flex items-center justify-between p-3 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg hover:shadow-md transition-all">
                <div className="flex items-center gap-3">
            ...
            <Routes>
              ...
              <Route path="*" element={
                <div className="text-center py-12 bg-white rounded-xl shadow-md">
                  ...
                  <a href="/" className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition-all shadow-md inline-block">
                    Go Home
                  </a>
                </div>
              } />
